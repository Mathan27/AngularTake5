...
export class NavContentComponent implements OnInit, AfterViewInit {
  ...
  constructor(public global: GlobalService, public nav: NavigationItem, private zone: NgZone, private location: Location) {
  ...
  ngOnInit() {
   ...
   console.log(this.global.userdata.username);
