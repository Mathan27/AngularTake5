...
export class BreadcrumbComponent implements OnInit {
  ...
  constructor(public global: GlobalService, private route: Router, public nav: NavigationItem, private titleService: Title) {
    this.type = 'theme2';
  }
  ...
  ngOnInit() {
    ...
    this.navigation = this.nav.get(this.global.userdata.role);
  ...
  filterNavigation(activeLink) {
    ...
    this.titleService.setTitle(title + ' | WOW NATURALS |  PANEL');
  }
