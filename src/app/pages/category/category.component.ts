...
export class CategoryComponent implements OnInit {
  ...
  lenders(loading) {
    ...
    this.global.http.post(this.global.server + 'category/view.php', postData, {})
      .subscribe(data => {
        console.log(data);
...
updatelender(form: any) {
  ...
  delete(id) {
    ...
    this.global.http.post(this.global.server + 'category/delete.php', postData, {})
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
  ...
  chnagestatus(id, status) {
    ...
    this.global.http.post(this.global.server + 'category/update.php', postData, {})
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
