...
@Component({
  selector: 'app-updatesubitem',
  templateUrl: './updatesubitem.component.html',
  styleUrls: ['./updatesubitem.component.scss']
})
export class UpdatesubitemComponent implements OnInit {
  ...
  public uploadedFilesimage: Array < File > = [];
  selectedsite : any; 
  siteoptions: any[];
  id:any;
  ...
  lenders(loading) {
    ...
    this.global.http.post(this.global.server + 'products/getsubitem.php', postData, httpOptions)
      .subscribe(data => {
        console.log(data);
 ...
 loadsubproducts() {
    ...
    // this.formdata = this.formInput;
      ...
      this.global.http.post(this.global.server + 'products/getimages.php', postData, httpOptions)
      .subscribe(data => {
        console.log(data);
        this.subproducts = [];
        // tslint:disable-next-line: triple-equals
  ...
  upload() {
    ...
    console.log(this.formInput3.sku);
    if (!this.formInput3.sku) {
      this.formInput3.sku = "-";
    }
    ...
    this.formInput3.pid = this.id;

    let formData: FormData = new FormData();
    console.log(this.uploadedFiles);
   
    if (this.uploadedFilesimage[0]) {


      const file: File = this.uploadedFilesimage[0];
      formData.append('file', file, file.name);
    }
    console.log(this.formInput3);
    ...
    this.global.http.post(this.global.server + 'products/uploadimage.php', formData, httpOptions)
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
  ...
  updatestock(form: any) {
    ...
    this.global.http.post(this.global.server + 'products/updatesubitem.php', formData, httpOptions)
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
  ...
  delete(id) {
    ...
    this.global.http.post(this.global.server + 'products/deletesubimages.php', postData, httpOptions)
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
