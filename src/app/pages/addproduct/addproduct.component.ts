...
export class AddproductComponent implements OnInit {
  ...
  lenders(loading) {
    ...
    this.global.http.post(this.global.server + 'banners/listbanner.php', postData, httpOptions)
      .subscribe(data => {
        console.log(data);
...
this.global.http.post('http://13.127.106.5/henred/banners/addbanner.php', postData, httpOptions)
  ...
  updatelender(form: any) {
    ...
    this.global.http.post(this.global.server + 'banners/updatebasdsnner.php', formData, httpOptions)
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
  ...
  delete(id) {
    ...
    this.global.http.post(this.global.server + 'banners/deletebadsdsnner.php', postData, httpOptions)
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
  ...
  chnagestatus(id, status) {
    ...
    this.global.http.post(this.global.server + 'updatestatudsds.php', postData, httpOptions)
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
