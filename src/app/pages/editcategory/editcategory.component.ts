...
initial(id)
{
  ...
  this.global.http.post(this.global.server + 'category/singlecategory.php', postData, {})
  .subscribe(data => {
    console.log(data);
...
console.log(this.formInput3.uploadedFiles[0]);
  ...
  if (this.formInput3.uploadedFiles[0]) {
    const file: File = this.formInput3.uploadedFiles[0];
    console.log(file);
...
console.log("formData");
    ...
    this.global.http.post(this.global.server + 'category/update.php', formData, httpOptions)
      .subscribe(data => {
        console.log(data);
        // tslint:disable-next-line: triple-equals
        if (data['status'] == 'success') {
